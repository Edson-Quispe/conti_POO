...
import pe.edu.continental.poo.taskapp.controladores.InscripcionJpaController;
...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private Inscripcion listaActual;
    ...
    private void initComponents() {
        ...
        btnNuevaTarea.setText("Agregar curso");
        ...
        btnBorrarTarea.setText("Borrar curso");
    ...
    private void btnBorrarListaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarListaActionPerformed
        // TODO add your handling code here:
        listaActual = new InscripcionJpaController(emf).getInscripcion(usuario.getId(), lstListaTareas.getSelectedValue());
    ...
    private void actualizarListaTareas() {
        InscripcionJpaController ltjc = new InscripcionJpaController(emf);
        lstListaTareas.setModel(new AbstractListModel<String>(){
            ArrayList<Inscripcion> inscripciones = new ArrayList<>(ltjc.findInscripcionByUsuario(usuario.getId()));
            @Override
            public int getSize() {
            ...
            public String getElementAt(int index) {
                return inscripciones.get(index).getNombre();
            }
        });
    }
    ...
    private void mostrarTareas(Long id) {
        ...
        List<Inscripcion> inscripciones = new InscripcionJpaController(emf).findInscripcionEntitiesByLista(id);
